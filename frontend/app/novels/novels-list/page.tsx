...
import { novel_columns, admin_novel_columns } from './table-columns.tsx';
...
export default function Page() {
  ...
  return (
    <div className="items-center justify-center">
      ...
      {isLoading
        ? <Loading />
        : <DataTable columns={novel_columns} admin_columns={admin_novel_columns} data={novels} setData={setNovels} />
      }
    </div>
  );
};
